...
export const tools: Tool[] = [
  {
    id: "chatgpt",
    name: "ChatGPT",
    description: "The world's most popular AI assistant. Perfect for writing, analysis, programming, and more.",
    category: "Chatbots",
  ...
  },
  {
    id: "midjourney",
    name: "Midjourney",
    description: "High-quality AI image generator. Create professional art, designs, and illustrations in seconds.",
  ...
  },
  {
    id: "github-copilot",
    name: "GitHub Copilot",
    description: "AI-powered code assistant. Write code faster with intelligent suggestions.",
  ...
  },
  {
    id: "jasper",
    name: "Jasper",
    description: "AI writing tool for marketing content. Create persuasive copy in minutes.",
  ...
  },
  {
    id: "dallae",
    name: "DALL-E 3",
    description: "Advanced image generator from OpenAI. Create realistic and artistic images.",
    category: "Image Generators",
    image: "https://private-us-east-1.manuscdn.com/sessionFile/gGotYcM8JXAasvTqz6sSPE/sandbox/BiJHyCa5TvWBH8T4B8gFfW-img-2_1770860594000_na1fn_dG9vbHMtaWxsdXN0cmF0aW9u.png?x-oss-process=image/resize,w_1920,h_1920/format,webp/quality,q_80&Expires=1798761600&Policy=_&Key-Pair-Id=K2HSFNDJXOU9YS&Signature=qjU8fNEuIbccmK9BIQw-OQeAUfzHHgBl6Dih9YDpe6q3tGNu6VhGkR9WocjaAhF2geUcv2qbng2cu-U3i56FDLO6~zoyDD18m0lgDX~18US2HXaVR5UcrWruCGQHA5K7vthv~7yJLrTiCw1n2ppfuSL1Xj4RXFmb-gEGa6C1jTIfvGBSnWriKIDepu~rrt94MQyzL9wIyia0O4wkgRnNhIvFO-ZFn6HhrwQhmFXzfhvQz5m3NIyo1epARI2bFvcYXSMTV2HCtPEMC10eUZUdg4jq3WxA5Aqgqeb1VSijeJyfPcJNkZb5UtER8XQw7VgB4bHbgakOHlUwG2ruSC37BQ__",
  ...
  },
  {
    id: "notion-ai",
    name: "Notion AI",
    description: "AI integration within Notion. Write, edit, and organize with AI assistance.",
